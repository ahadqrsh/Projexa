import {
  insertCluster
} from "./chunk-GXFU76GW.js";
import {
  insertEdge,
  insertEdgeLabel,
  markers_default,
  positionEdgeLabel
} from "./chunk-WWBNI73D.js";
import {
  insertNode
} from "./chunk-657UVABO.js";
import {
  labelHelper
} from "./chunk-B65SLAVD.js";
import {
  interpolateToCurve
...
var registerDefaultLayoutLoaders = __name(() => {
  registerLayoutLoaders([
    {
      name: "dagre",
      loader: __name(async () => await import("./dagre-3AP2YEHR-VRYE3533.js"), "loader")
    },
    {
      name: "swimlane",
      loader: __name(async () => await import("./swimlanes-XN3QIQJK-AZ5GND5N.js"), "loader")
    },
    ...true ? [
      {
        name: "cose-bilkent",
...
//# sourceMappingURL=chunk-46UCFB2T.js.map
