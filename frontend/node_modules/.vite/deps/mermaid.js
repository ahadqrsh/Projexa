...
} from "./chunk-46UCFB2T.js";
import {
  clearLayoutRenderState,
  createCommonLayoutRenderer,
  defaultMeasureLayout,
  paintLayoutData
} from "./chunk-7WNX73KO.js";
import "./chunk-TKIRVWWT.js";
import "./chunk-GXFU76GW.js";
import "./chunk-WWBNI73D.js";
import "./chunk-657UVABO.js";
import "./chunk-B65SLAVD.js";
import "./chunk-TNWHCC6S.js";
import "./chunk-5UR6A2NX.js";
import {
  dedent
} from "./chunk-5H3VPNMC.js";
import {
  registerIconPacks
} from "./chunk-ROL4L7NV.js";
import {
  cleanAndMerge,
  decodeEntities,
  encodeEntities,
...
var loader = __name(async () => {
  const { diagram: diagram2 } = await import("./c4Diagram-UCG6FXSJ-MAOCMULF.js");
...
var loader2 = __name(async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-A5DVABFB-AVWYKJJ3.js");
...
var loader4 = __name(async () => {
  const { diagram: diagram2 } = await import("./swimlanesDiagram-VK2B7HYN-ZQUXKBKP.js");
...
var loader5 = __name(async () => {
  const { diagram: diagram2 } = await import("./erDiagram-SSCWMZ5O-3HXWYNLX.js");
...
var loader6 = __name(async () => {
  const { diagram: diagram2 } = await import("./gitGraphDiagram-WWUBYQGX-7LC3VFJS.js");
...
var loader7 = __name(async () => {
  const { diagram: diagram2 } = await import("./ganttDiagram-EL5Y4UJY-UIITDU6C.js");
...
var loader8 = __name(async () => {
  const { diagram: diagram2 } = await import("./infoDiagram-RXCK75RN-V2KN6EZ7.js");
...
var loader9 = __name(async () => {
  const { diagram: diagram2 } = await import("./pieDiagram-E7YTZNPT-S5P7JK4P.js");
...
var loader10 = __name(async () => {
  const { diagram: diagram2 } = await import("./quadrantDiagram-AXDQQJYC-BXKWUFE2.js");
...
var loader11 = __name(async () => {
  const { diagram: diagram2 } = await import("./xychartDiagram-S5SC5T6Z-Q33X667D.js");
...
var loader12 = __name(async () => {
  const { diagram: diagram2 } = await import("./requirementDiagram-EFPCY7ZU-DBG6EW6Z.js");
...
var loader13 = __name(async () => {
  const { diagram: diagram2 } = await import("./sequenceDiagram-WJ2MYXX4-G3NBDKKR.js");
...
var loader14 = __name(async () => {
  const { diagram: diagram2 } = await import("./classDiagram-DTDB5LWJ-HL355W47.js");
...
var loader15 = __name(async () => {
  const { diagram: diagram2 } = await import("./classDiagram-v2-JRS7N3AN-SGD3H3LB.js");
...
var loader16 = __name(async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-HBIQ2CUA-4U6ZQOTB.js");
...
var loader17 = __name(async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-v2-4QOOHH4V-3H6LTQRT.js");
...
var loader18 = __name(async () => {
  const { diagram: diagram2 } = await import("./journeyDiagram-EYS64GPL-IXZYBELE.js");
...
var loader20 = __name(async () => {
  const { diagram: diagram2 } = await import("./timeline-definition-24CTP7MA-55LLJSTK.js");
...
var loader21 = __name(async () => {
  const { diagram: diagram2 } = await import("./mindmap-definition-FBJOCRG2-3S2BEC25.js");
...
var loader22 = __name(async () => {
  const { diagram: diagram2 } = await import("./kanban-definition-3QL26DDD-X2TRP4UL.js");
...
var loader23 = __name(async () => {
  const { diagram: diagram2 } = await import("./sankeyDiagram-P5KCCOFB-CP7LU4WS.js");
...
var loader24 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-Z3DM3KII-EI4DERHU.js");
...
var loader25 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-UQ7AKVKN-V7PHOLXJ.js");
...
var loader26 = __name(async () => {
  const { diagram: diagram2 } = await import("./blockDiagram-NRAW4CY4-WKIRNMWM.js");
...
var loader27 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-S7CK7UJ4-ORO32TME.js");
...
var loader28 = __name(async () => {
  const { diagram: diagram2 } = await import("./architectureDiagram-5GKGNRK7-LJZNHLJO.js");
...
var loader29 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-VSXAHHWV-HBPNVRMD.js");
...
var loader30 = __name(async () => {
  const { diagram: diagram2 } = await import("./ishikawaDiagram-5VMMS53U-WAXAVALT.js");
...
var loader31 = __name(async () => {
  const { diagram: diagram2 } = await import("./vennDiagram-4TSXK5OY-BY74IOVG.js");
...
var loader32 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-VX7I27RA-LS6QWD3U.js");
...
var loader33 = __name(async () => {
  const { diagram: diagram2 } = await import("./wardleyDiagram-VM6X3IG4-XHAP27GL.js");
...
var loader34 = __name(async () => {
  const { diagram: diagram2 } = await import("./cynefinDiagram-5FMLGOSQ-KCWOJZFW.js");
...
var loader35 = __name(async () => {
  const { diagram: diagram2 } = await import("./railroadDiagram-O6MQD6OU-AZV34NWJ.js");
...
var loader36 = __name(async () => {
  const { diagram: diagram2 } = await import("./ebnfDiagram-PWID7BFC-EHCMSD4I.js");
...
var loader37 = __name(async () => {
  const { diagram: diagram2 } = await import("./abnfDiagram-VCTEODGH-P5IWKIS3.js");
...
var loader38 = __name(async () => {
  const { diagram: diagram2 } = await import("./pegDiagram-XKGWAZYB-ZZMHNXTM.js");
